        ...
        >
                    ...
                    return (
                      <li key={item.to}>
                        ...
                        >
                          ...
                          <Icon
                            className={`relative size-4 ${active ? "text-electric" : ""}`}
                            aria-hidden
                          />
          ...
          <div className="m-3 rounded-xl border border-border bg-card p-3.5 shadow-soft">
            ...
            <p className="mt-2 text-xs text-muted-foreground leading-relaxed">
              Ask anything — resume tips, learning paths, interview prep.
            </p>
            <Button
              size="sm"
              className="mt-3 w-full h-8 text-xs bg-foreground text-background hover:bg-foreground/90"
          ...
          <header className="sticky top-0 z-20 flex h-14 items-center gap-3 border-b border-border bg-background/80 px-4 backdrop-blur-md sm:px-6">
            ...
            <div className="ml-auto flex items-center gap-2">
              <Button
                variant="ghost"
                size="sm"
                className="hidden sm:inline-flex h-9 text-xs gap-2 text-muted-foreground"
              >
              ...
              >
                ...
                <span
                  className="absolute right-2 top-2 size-1.5 rounded-full bg-electric ring-2 ring-background"
                  aria-hidden
                />
              </Button>
              <div className="flex items-center gap-2 rounded-full border border-border bg-card pl-1 pr-3 py-1">
                ...
                <div className="hidden sm:block leading-tight">
                  <p className="text-xs font-semibold">ajay Kumar</p>
